...
$status = mysqli_query($conn,"UPDATE volunteerdata SET sex = '$sex', dob = '$dob', mobileNo = $mobileNo, wtspNo = '$wtspNo', language1 = '$language1', language2 = '$language2' WHERE volunteerId = '$userId'");
