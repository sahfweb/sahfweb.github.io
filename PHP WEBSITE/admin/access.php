...
session_start();
$profileName = "Shubham Yadav";
$email = "syrohuwar@gmail.com";
$adminId = "1";
                ...
                <div class="row">
                    ...
                    <div class="col-sm-8">
                        <p class="text-muted mb-0">
                            <input class="mt-2 form-control text-success" name="noticeDate" type="datetime-local" placeholder="Enter date for Notice" required>
                        </p>
                    </div>
                </div>
                <hr>
