...
$file_name1=$path1.$_SESSION['userdata']['volunteerId'].date("d-m-Y-H-i-s").$_FILES['photo']['name'];
$file_name2=$path2.$_SESSION['userdata']['volunteerId'].date("d-m-Y-H-i-s").$_FILES['signature']['name'];
...
$status = mysqli_query($conn,"UPDATE volunteerdata SET photo = '$file_name1', signature = '$file_name2' WHERE volunteerId = $volunteerId");
