...
<body>
    ...
    <section class="PAST-EVENT">
        ...
        <div class='event-all'>
            ...
            $sql_cursor = mysqli_query($conn, "SELECT * FROM event WHERE event.type = 'PAST' ORDER BY eventId DESC");

            if (mysqli_num_rows($sql_cursor) == 0) {
                echo "<div class='event-all'>
                <div class='past-cont'>
                    <div class='event-contall'>
                        <h3><br><br><br>We don't have any past events right now. To stay updated, please check on us again.<br><br><br><br></h3>
                    </div>
                </div>
            </div>";
            } else {
