...
<body>
    ...
    <section class="welcome-to">
        ...
        <div class="welcome-allimg">
            <div class="welcome-img">
                <img src="images1/galleryimg/education13.jpg">
                <i class="fa-solid fa-book-open-reader"></i>
                <h2>We Care Education </h2>
                <p>"Education is key of opportunity"
                    Education develops human personality, thoughts, dealing with others and prepares people for life experiences.
                    Learning, or the acquisition of knowledge, skills, values, morals, beliefs, talents, habits, and personal development,
    ...
    <section class="event">
        ...
        <div class="event-cont">
            <div class="event-img">
                <img src="images1/galleryimg/education9.jpg">
                <h2>UPCOMING EVENT </h2>
                <p>We will be organising multiple new events in upcoming month.
                     stay updated by frequently visiting our website....<a href="upcomingevent.php">read more</a></p>
            </div>
            <div class="event-img">
                ...
                <p>
                    ...
                    This is for 0-8th students. The biggest problem.... <a href="campaign.php">read more</a></p>
            </div>
            <div class="event-img">
                <img src="images1/homeimg/Upcoming event.jpg">
                <h2>PAST EVENT </h2>
                <p id="ABOUT">
                    In past few months we have organised multiple event.
                    you can see them using this link.<a href="pastevent.php">click here</a></p>
            </div>
        </div>
    </section>
    ...
    <section class="about">
        ...
        <div class="about-cont">
            <div class="about-img">
                <img src="images1/galleryimg/education11.jpg">
                <h2>What We Do </h2>
            ...
            <div class="about-img">
                <img src="images1/galleryimg/humanity5.jpg">
                <h2>How It Works </h2>
    ...
    <section class="counter">
        <div class="counterdiv1">
            ...
            <div class="volunteer-join1"> <a href="login.php">JOIN NOW</a></div>
        </div>
        ...
        <div id="counter-happychi" class="countershow">
            ...
            <h2 class="counter-number">3600+</h2>
            <p> BENEFICIARY</p>
        </div>
    ...
    <section class="video">
        ...
        <div class="video-cont">
            <div class="video-img">
                <iframe width="250" height="130" src="https://www.youtube.com/embed/-up4SGEo-T0" title="YouTube video player" frameborder="0" allow="accelerometer;
         autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                <h2>Finally on Ground level </h2>
            </div>
            <div class="video-img">
                <iframe width="560" height="315" src="https://www.youtube.com/embed/sJ-DeXe0-LM" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                <h2>SAHFZONE ActiveHumanityFoundation </h2>
            </div>
            <div class="video-img">
                <iframe width="560" height="315" src="https://www.youtube.com/embed/X4NcNJeWbe0" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write;
         encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                <h2>SAFEZONE ActiveHumanityFoundation </h2>
            </div>
            <div class="video-img">
                <iframe width="560" height="315" src="https://www.youtube.com/embed/i9_JcWI72Lw" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
